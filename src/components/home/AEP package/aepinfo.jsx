  ...
  <section className="aepinfo_section">
    <div className="aepinfo_container">
      ...
      <div className="aepinfo_middle">
        ...
        <AemCard title={"DB Monitoring Dashboard"} text1={"monitors real-time session & transaction lock"}text2={"provides status for server CPU & memory"} ></AemCard>
        <AemCard title={"Schedule Management"} text1={"provides module for script, SQL job, and scheduling management"}text2={"provides UX dedicated to scheduling"} ></AemCard>
        <AemCard title={"Database Audit"} text1={"enables auditing via user interface"}text2={"view audit results via user interface"} ></AemCard>
        <AemCard title={"SQL Monitoring"} text1={"collects query statistics required for performance analysis"}text2={"extracts monitoring results in query"} ></AemCard>
        <AemCard title={"Performance Management"} text1={"monitors and collects operation status & statistical data"}text2={"provides status reports required for improving performance"} ></AemCard>
